...
var blockFile = '$HOME/poa-simple-notification-service/core_proxy_block';



log4js.configure({
    appenders: { core_proxy: { type: 'file', filename: '$HOME/poa-simple-notification-service/core/logs/core_proxy.log' } },
...
const POA_ABI = require('$HOME/poa-simple-notification-service/core/abis/VotingToChangeProxyAddress.abi.json');
