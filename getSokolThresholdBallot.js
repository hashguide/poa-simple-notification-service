...
var blockFile = '/home/validator/dev/poa/poa-simple-notification-service/sokol_threshold_block';


log4js.configure({
    appenders: { sokol_threshold: { type: 'file', filename: '/home/validator/dev/poa/poa-simple-notification-service/sokol/logs/sokol_threshold.log' } },
...
const POA_ABI = require('/home/validator/dev/poa/poa-simple-notification-service/sokol/abis/VotingToChangeMinThreshold.abi.json');
const Web3 = require('web3');
const sokol = 'https://sokol.poa.network'
const provider = new Web3.providers.HttpProvider(sokol);
const web3 = new Web3(provider);
const CONTRACT_ADDR = '0x700db8ba3128087f3b23f60de4bc3179bafa467d';
