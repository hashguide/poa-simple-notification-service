...
var blockFile = '$HOME/poa-simple-notification-service/core_emission_block';

log4js.configure({
    appenders: { core_emission: { type: 'file', filename: '$HOME/poa-simple-notification-service/core/logs/core_emission.log' } },
...
const POA_ABI = require('$HOME/poa-simple-notification-service/core/abis/VotingToManageEmissionFunds.abi.json');
