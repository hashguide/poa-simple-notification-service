...
var blockFile = '$HOME/poa-simple-notification-service/core_voting_block';



log4js.configure({
    appenders: { voting_core: { type: 'file', filename: '$HOME/poa-simple-notification-service/core/logs/core_voting.log' } },
...
const POA_ABI = require('$HOME/poa-simple-notification-service/core/abis/voting-core.json');
