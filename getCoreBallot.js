...
var blockFile = '/home/jhl/dev/poa/poa-simple-notification-service/core_voting_block';



log4js.configure({
    appenders: { voting_core: { type: 'file', filename: '/home/jhl/dev/poa/poa-simple-notification-service/core/logs/core_voting.log' } },
...
const POA_ABI = require('/home/jhl/dev/poa/poa-simple-notification-service/core/abis/voting-core.json');
const Web3 = require('web3');
const sokol = 'https://core.poa.network'
const provider = new Web3.providers.HttpProvider(sokol);
const web3 = new Web3(provider);
const CONTRACT_ADDR = '0xA4508af18F1005943678769dB3D95223C062258D';
