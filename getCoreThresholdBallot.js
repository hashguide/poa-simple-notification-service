...
var blockFile = '/home/serv1/poa-simple-notification-service/core_threshold_block';

log4js.configure({
    appenders: { core_threshold: { type: 'file', filename: '/home/serv1/poa-simple-notification-service/core/logs/core_threshold.log' } },
...
const POA_ABI = require('/home/serv1/poa-simple-notification-service/core/abis/VotingToChangeMinThreshold.abi.json');
const Web3 = require('web3');
const core = 'https://core.poa.network'
const provider = new Web3.providers.HttpProvider(core);
const web3 = new Web3(provider);
const CONTRACT_ADDR = '0xa45e35472693AE60a95DB8cB1cE73eEa22ab5328';
